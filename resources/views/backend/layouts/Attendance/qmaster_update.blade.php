                ...
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">
                            <h3>Update Quarter Master Attendance Information</h3>
                        </div>
                    </div> 
                <div class="ibox-body">
                    <form action="{{route('puo.update-method-qmaster-att',$attendance->id)}}" role="form" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-sm-4 form-group">
                                <label>Cadet ID</label>
                                <input class="form-control" type="text" readonly autofocus value="{{($attendance->qmaster)->cdt_id}}">
                            </div>
                            <div class="col-sm-4 form-group">
                                <label>Cadet Name</label>
                                <input class="form-control" type="text" readonly autofocus value="{{($attendance->qmaster)->name}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 form-group">
