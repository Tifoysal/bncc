            <footer class="page-footer">
                <div class="footnote">
                    2019 © <b>IUBAT BNCC Platoon</b> - All rights reserved.
                </div>
                <p>Developed  By
                    <a href="http://rihab.bd.education/" target="_blank">Rihab Rahman</a>
                </p>
...
<!--    <script src="{{asset('/')}}backend/user/vendors/jquery/dist/jquery.min.js" type="text/javascript"></script>-->
    ...
    <script src="{{asset('/')}}backend/user/vendors/jquery-slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
    <!-- PAGE LEVEL PLUGINS-->
    <script src="{{asset('/')}}backend/user/vendors/chart.js/dist/Chart.min.js" type="text/javascript"></script>
    <script src="{{asset('/')}}backend/user/vendors/jvectormap/jquery-jvectormap-2.0.3.min.js" type="text/javascript"></script>
    <script src="{{asset('/')}}backend/user/vendors/jvectormap/jquery-jvectormap-world-mill-en.js" type="text/javascript"></script>
    <script src="{{asset('/')}}backend/user/vendors/jvectormap/jquery-jvectormap-us-aea-en.js" type="text/javascript"></script>
